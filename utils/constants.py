...
# DISCORD_CHANNEL_ID is now optional - set via !setchannel command
# Keep for backward compatibility if set in .env
_channel_id = os.getenv("DISCORD_CHANNEL_ID")
DISCORD_CHANNEL_ID = int(_channel_id) if _channel_id else None
